  ...
  new Feature(
    ...
    [
      ...
      new Feature(
        'searchFile',
        'File search',
        'Use the file explorer to search for files in the workspace.',
      ),
    ],
  ),
  new Feature(
  ...
  new Feature(
    ...
    [
      ...
      new Feature(
        'autoSyncWorkspace',
        'Workspace auto-sync',
        'Use the "Manage workspaces" dialog to open a workspace auto-sync.',
      ),
      new Feature(
        'stopAutoSyncWorkspace',
        'Workspace close auto-sync',
        'Use the "Manage workspaces" dialog to close a workspace auto-sync.',
      ),
    ],
  ),
  new Feature(
    ...
    [
      ...
      new Feature(
        'addSmmsAccount',
        'SM.MS user',
        'Link your SM.MS account to StackEdit.',
      ),
      new Feature(
        'addCustomAccount',
        'Custom image bed user',
        'Link your Custom image bed account to StackEdit.',
      ),
      new Feature(
        'removeAccount',
        'Revoker',
  ...
  new Feature(
    ...
    [
      ...
      new Feature(
        'openFromGitee',
        'Gitee reader',
        'Use the "Synchronize" menu to open a file in a Gitee repository.',
      ),
      new Feature(
        'saveOnGitee',
        'Gitee writer',
  ...
  new Feature(
    ...
    [
      ...
      new Feature(
        'switchTheme',
        'Switch theme',
        'Use the "Switch theme" buuton switch theme.',
      ),
      new Feature(
        'changeShortcuts',
        'Shortcut editor',
